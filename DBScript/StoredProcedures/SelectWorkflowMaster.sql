--region PROCEDURE [dbo].[SelectWorkflowMaster] @OrganizationId=1, @SqlWhereClause='( Name like ''%Test%'' )'
IF OBJECT_ID('[dbo].[SelectWorkflowMaster]') IS NOT NULL 
    BEGIN 
        DROP PROC [dbo].[SelectWorkflowMaster] 
    END 
GO 
     
CREATE PROC [dbo].[SelectWorkflowMaster] 
( 
	@Page INT = 1,
	@PageSize INT = 10,
	@OrganizationId INT,
...
BEGIN
	...
	SET @Query = N'
				...
				SELECT * FROM [dbo].[WorkflowMaster] WHERE OrganizationId=@OrganizationId';

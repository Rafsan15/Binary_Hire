...
GO
IF NOT EXISTS (SELECT * FROM [dbo].[Setting] WHERE SettingType = 'EmailTemplateType' AND DisplayText = 'Acceptance')
	INSERT [dbo].[Setting] ([ID], [SettingType], [DisplayText]) VALUES (21,N'EmailTemplateType',N'Acceptance')
GO
IF NOT EXISTS (SELECT * FROM [dbo].[Setting] WHERE SettingType = 'EmailTemplateType' AND DisplayText = 'Reject')
	INSERT [dbo].[Setting] ([ID], [SettingType], [DisplayText]) VALUES (22,N'EmailTemplateType',N'Reject')
GO
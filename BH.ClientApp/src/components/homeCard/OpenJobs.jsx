...
const OpenJobs = ({ job, handleFavoriteToggle }) => {
  ...
  return (
    <>
      ...
      >
        <div className='relative mb-4 flex flex-col  text-gray-700 bg-white shadow-md border bg-clip-border rounded-xl w-full hover:bg-green-100 transition-colors duration-300'>
          <div className='p-6'>
          ...
          <div className='p-6 pt-0 flex items-center justify-between'>
            <div className='block font-sans text-base antialiased font-semibold leading-relaxed text-green-600 bg-green-100 p-1 rounded-md'>
              {job.statusName}
            </div>
            <button
              onClick={(e) => {

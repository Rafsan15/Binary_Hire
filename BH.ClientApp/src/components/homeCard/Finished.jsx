  ...
  return (
    <>
      <Link className='flex' to={`/result/${job.id}`}>
        <div className='relative mb-4 flex flex-col  text-gray-700 bg-white shadow-md border bg-clip-border rounded-xl w-full hover:bg-blue-100 transition-colors duration-300'>
          <div className='p-6'>
          ...
          <div className='p-6 pt-0 flex items-center justify-between'>
            <div className='block font-sans text-base antialiased font-semibold leading-relaxed text-blue-600 bg-blue-100 p-1 rounded-md'>
              {job.statusName}
            </div>
            <button
              onClick={(e) => {

...
const WorkflowPage = () => {
  ...
  useEffect(() => {
    ...
    axios.post(`${BASE_URL}WorkFlow/get-all`, requestBody, {
      headers: {
  ...
  useEffect(() => {
    ...
    axios.get(`${BASE_URL}WorkFlow/get-all-workflow-type`, {
      headers: {
  ...
  return (
    <div className='flex flex-1'>
      ...
      <Breadcrumbs aria-label="breadcrumb" style={{ marginTop: '20px', marginLeft: '20px', marginBottom: '20px' }}>
  <StyledBreadcrumb
    component="a"
    href="#"
    label="Home"
  ...
  />
        ...
        >
          ...
          >
            <option key={-1} value={'Select Workflow'} id={-1}>Select Workflow</option>

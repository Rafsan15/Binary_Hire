--region PROCEDURE [dbo].[SelectAssessment] @OrganizationId=1
IF OBJECT_ID('[dbo].[SelectAssessment]') IS NOT NULL 
    BEGIN 
        DROP PROC [dbo].[SelectAssessment] 
    END 
GO 
     
CREATE PROC [dbo].[SelectAssessment] 
( 
	@Page INT = 1,
	@PageSize INT = 10,
	@OrganizationId INT,
...
BEGIN
	...
	SET @Query = N'
				...
				* FROM (
				...
				LEFT JOIN [dbo].[Question] AS [QS] ON [QS].[Id] = [ASM].[QuestionId]
				WHERE [ASM].[OrganizationId]=@OrganizationId';

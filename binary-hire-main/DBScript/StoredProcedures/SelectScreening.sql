--region PROCEDURE [dbo].[SelectScreening]
IF OBJECT_ID('[dbo].[SelectScreening]') IS NOT NULL 
    BEGIN 
        DROP PROC [dbo].[SelectScreening] 
    END 
GO 
     
CREATE PROC [dbo].[SelectScreening] 
( 
	@Page INT = 1,
	@PageSize INT = 10,
	@OrganizationId INT,
...
BEGIN
	...
	SET @Query = N'
				...
				SELECT * FROM [dbo].[Screening] WHERE OrganizationId=@OrganizationId';

...
namespace BH.Services.Extensions
{
	...
	{
        public static string sharedFolderLink = ""; // Shared link to the folder
        public static string localFolderPath = "D:\\Planspiel\\b_cvs"; // Path to local folder where files will be saved
        ...
        private static Dictionary<string, string> ListFiles(DriveService service, string folderId)
        {
        ...
        private static void DownloadFile(DriveService service, string fileId, string fileName)
        {
        ...
        private static void ClearLocalFolder(string folderPath)
        {
            try
            {
